...
// *** التعديل هنا: استيراد صورة الداشبورد الجديدة ***
// (تأكد من حفظ الصورة باسم powerbi_dashboard.png في فولدر src/assets)
      ...
      <>
        <div className="relative">
          ...
          <div className="w-full flex">
            {/* تم تحديث النص هنا إلى اللغة الإنجليزية بناءً على طلبك */}
            <motion.p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
              Explore a collection of my work in Data Science, Data Analysis, and Machine Learning. These real-world projects showcase my capability to solve technical problems, build predictive models, and extract actionable insights from data. Code and live demos are available for each.
            </motion.p>
            <Image
                src={color_sharp}
                alt="color-sharp"
